 ...
 * 
 * BUYMYAD->settings->get_plugin_name();
 * 
 * HELPER COMMENT END
 */

/**
 * Class Buymyad_Settings
 *
 * This class contains all of the plugin settings.
 * Here you can configure the whole plugin data.
 *
 * @package		BUYMYAD
 * @subpackage	Classes/Buymyad_Settings
 * @author		Chris Brody
 * @since		1.0.0
 */
class Buymyad_Settings{
	...
	/**
	 * Our Buymyad_Settings constructor 
	...
	public function get_plugin_name(){
		return apply_filters( 'BUYMYAD/settings/get_plugin_name', $this->plugin_name );
	}
}
